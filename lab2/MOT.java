...
class Car implements IMOT {
  ...
  // returns true if this car is at least
  // as efficient as the given mpg, false otherwise
  public boolean isMoreFuelEfficientThan(int mpg) {
    return this.mpg >= mpg;
  }
...
class ExamplesPerson {
  ...
  boolean testMotMeetsFuelEfficiency(Tester t) {
    return t.checkExpect(this.bob.motMeetsFuelEfficiency(10), true)
        && t.checkExpect(this.ben.motMeetsFuelEfficiency(34), false)
